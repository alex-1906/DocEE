...
# %%
df.loc['35_VOA_EN_NW_2015.04.08.2711451']
# %%
df.loc['61_VOA_EN_NW_2017.03.22.3777524']

# %%
df.loc[['scenario_en_kairos_0', '61_VOA_EN_NW_2017.03.22.3777524','35_VOA_EN_NW_2015.04.08.2711451', 'scenario_en_kairos_43']].event_mentions[4]
# %%
df['event_len'] = df['event_mentions'].apply(lambda x: len(x))
df['ent_len'] = df['entity_mentions'].apply(lambda x: len(x))


# %%
df.iloc[8:20]
# %%
df.loc[['road_ied_9', 'scenario_en_kairos_15']]
# %%
df.loc[['wiki_ied_bombings_3_news_5', '74_VOA_EN_NW_2017.05.24.3868599']]
